  ...
  return (
    ...
    gap-8 2xl:gap-30 mb-20'>
    {
      data.map((item,index)=>(
        ...
        items-center justify-between gap-5 px-4 md:px-8 py-12 rounded-lg bg-gray-50
        dark:bg-slate-800 border border-gray-100 dark:border-slate-900'>


          <div className='flex items-center gap-2'>
            <div className={`w-12 h-12 flex items-center justify-center
            rounded-full ${ICON_STYLES[index]}`}>
    ...
    <div>
      <p className={`flex gap-1 items-center text-base md:text lg
        font-semibold ${
